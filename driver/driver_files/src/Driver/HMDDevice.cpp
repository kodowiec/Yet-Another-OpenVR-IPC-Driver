...
YetAnotherDriver::HMDDevice::HMDDevice(std::string serial):serial_(serial)
{
}

std::string YetAnotherDriver::HMDDevice::GetSerial()
{
    return this->serial_;
}

void YetAnotherDriver::HMDDevice::Update()
{
...
DeviceType YetAnotherDriver::HMDDevice::GetDeviceType()
{
    return DeviceType::HMD;
}

vr::TrackedDeviceIndex_t YetAnotherDriver::HMDDevice::GetDeviceIndex()
{
    return this->device_index_;
}

vr::EVRInitError YetAnotherDriver::HMDDevice::Activate(uint32_t unObjectId)
{
...
void YetAnotherDriver::HMDDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void YetAnotherDriver::HMDDevice::EnterStandby()
{
}

void* YetAnotherDriver::HMDDevice::GetComponent(const char* pchComponentNameAndVersion)
{
...
void YetAnotherDriver::HMDDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t YetAnotherDriver::HMDDevice::GetPose()
{
    return this->last_pose_;
}

void YetAnotherDriver::HMDDevice::GetWindowBounds(int32_t* pnX, int32_t* pnY, uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnX = this->window_x_;
    *pnY = this->window_y_;
...
bool YetAnotherDriver::HMDDevice::IsDisplayOnDesktop()
{
    return true;
}

bool YetAnotherDriver::HMDDevice::IsDisplayRealDisplay()
{
    return false;
}

void YetAnotherDriver::HMDDevice::GetRecommendedRenderTargetSize(uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnWidth = this->window_width_;
    *pnHeight = this->window_height_;
}

void YetAnotherDriver::HMDDevice::GetEyeOutputViewport(vr::EVREye eEye, uint32_t* pnX, uint32_t* pnY, uint32_t* pnWidth, uint32_t* pnHeight)
{
    *pnY = 0;
...
void YetAnotherDriver::HMDDevice::GetProjectionRaw(vr::EVREye eEye, float* pfLeft, float* pfRight, float* pfTop, float* pfBottom)
{
    *pfLeft = -1;
    *pfRight = 1;
    *pfTop = -1;
...
vr::DistortionCoordinates_t YetAnotherDriver::HMDDevice::ComputeDistortion(vr::EVREye eEye, float fU, float fV)
{

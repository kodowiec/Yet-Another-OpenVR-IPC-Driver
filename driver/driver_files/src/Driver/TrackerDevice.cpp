...
YetAnotherDriver::TrackerDevice::TrackerDevice(std::string serial, std::string role):
    serial_(serial),
    role_(role)
{
...
std::string YetAnotherDriver::TrackerDevice::GetSerial()
{
    return this->serial_;
}

void YetAnotherDriver::TrackerDevice::reinit(int msaved, double mtime, double msmooth)
{
...
void YetAnotherDriver::TrackerDevice::Update()
{
...
void YetAnotherDriver::TrackerDevice::Log(std::string message)
{
    std::string message_endl = message + "\n";
    vr::VRDriverLog()->Log(message_endl.c_str());
}

int YetAnotherDriver::TrackerDevice::get_next_pose(double time_offset, double pred[])
{
    int statuscode = 0;
...
void YetAnotherDriver::TrackerDevice::save_current_pose(double a, double b, double c, double w, double x, double y, double z, double time_offset)
{
    double next_pose[7];
...
DeviceType YetAnotherDriver::TrackerDevice::GetDeviceType()
{
    return DeviceType::TRACKER;
}

vr::TrackedDeviceIndex_t YetAnotherDriver::TrackerDevice::GetDeviceIndex()
{
    return this->device_index_;
}

vr::EVRInitError YetAnotherDriver::TrackerDevice::Activate(uint32_t unObjectId)
{
...
void YetAnotherDriver::TrackerDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void YetAnotherDriver::TrackerDevice::EnterStandby()
{
}

void* YetAnotherDriver::TrackerDevice::GetComponent(const char* pchComponentNameAndVersion)
{
    return nullptr;
}

void YetAnotherDriver::TrackerDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t YetAnotherDriver::TrackerDevice::GetPose()
{
    return last_pose_;
}
